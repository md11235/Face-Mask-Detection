...
if args["resume"] is None:
    ...
    attention_branch = Conv2D(1280, 3, padding='same')(headModel_gap)
    ...
    flat_headModel_gap = Flatten(name="flattern_headModel_gap")(headModel_gap)
    concatenated = Concatenate()([flat_headModel_gap, flat_attention])
    headModel = Dense(256, activation="relu")(concatenated)
